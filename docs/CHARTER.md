...
Current published library: **0.4.0** (host I/O: persist, idle `Tick(dt)`, named events, Utility-AI tint). Next coding work is a new milestone, not a rewrite of this charter.
