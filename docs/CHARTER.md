...
Current published library: **0.6.2** (plain-language front door, diagrams, playable examples host; GitHub Packages). Intended version order: [`ROADMAP.md`](ROADMAP.md). That order is not a rewrite of this charter.
