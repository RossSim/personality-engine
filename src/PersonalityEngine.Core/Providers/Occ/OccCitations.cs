...
internal static class OccCitations
{
    public static readonly Citation Occ1988 = new Citation(
        "occ-1988",
        "Ortony, A., Clore, G. L., & Collins, A. (1988). The Cognitive Structure of Emotions. Cambridge University Press. Emotion types from eliciting conditions (well-being, prospect-based, attribution, fortune-of-others). ISBN 978-0-521-38664-7.");
    ...
    public static readonly Citation Dynamics = new Citation(
        "pe-occ-dynamics",
        "Host-tagged eliciting events, 0..1 intensities, exponential decay toward 0, and OCC→PAD overlay coefficients (including fortune-of-others) are project conventions. This slice is not a full OCC goal/standard/attitude network.",
