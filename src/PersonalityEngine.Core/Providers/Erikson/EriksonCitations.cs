...
internal static class EriksonCitations
{
    public static readonly Citation ChildhoodAndSociety1963 = new Citation(
        "erikson-1963",
        "Erikson, E. H. (1963). Childhood and Society (2nd ed.). W. W. Norton. (Original work published 1950). Eight ages of man; epigenetic principle; syntonic/dystonic ratio.");

    public static readonly Citation IdentityAndTheLifeCycle1959 = new Citation(
        "erikson-1959",
        "Erikson, E. H. (1959). Identity and the Life Cycle. Psychological Issues, 1(1). International Universities Press.");

    public static readonly Citation IdentityYouthAndCrisis1968 = new Citation(
        "erikson-1968",
        "Erikson, E. H. (1968). Identity: Youth and Crisis. W. W. Norton. Identity crisis, role confusion, psychosocial moratorium, negative identity, fidelity.");

    public static readonly Citation LifeCycleCompleted1982 = new Citation(
        "erikson-1982",
        "Erikson, E. H. (1982). The Life Cycle Completed. W. W. Norton. Virtues of the life cycle; integrity vs despair.");

    public static readonly Citation YoungManLuther1958 = new Citation(
        "erikson-1958",
        "Erikson, E. H. (1958). Young Man Luther: A Study in Psychoanalysis and History. W. W. Norton. Psychohistory; documented, not implemented as an NPC biography engine.");
